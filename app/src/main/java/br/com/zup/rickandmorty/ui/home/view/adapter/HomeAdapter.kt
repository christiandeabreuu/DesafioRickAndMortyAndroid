...
class HomeAdapter(private var listRM: MutableList<CharacterEntity>) :
    ...
    class ViewHolder(private val binding: LayoutRmBinding) : RecyclerView.ViewHolder(binding.root) {
